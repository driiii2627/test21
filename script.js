...
const setLanguage = (lang) => {
    ...
    if(currentLangDisplay) {
        currentLangDisplay.innerHTML = `<img src="${langConfig.flag}" alt="${langConfig.name}" class="w-5 h-5 rounded-full mr-2">`;
    }
...
const showPage = (pageId) => {
    const pages = [$('#page-home'), $('#page-404'), $('#page-announcements'), $('#page-terms'), $('#page-privacy')];
    pages.forEach(page => {
